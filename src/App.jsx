...
function App() {
  return (
    <div
      data-theme="default"
      className="bg-background text-foreground font-sans selection:bg-primary selection:text-primary-foreground relative transition-colors duration-500 min-h-screen"
    >
      <Navbar />
